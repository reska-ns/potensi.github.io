              ...
              <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Data Usability Testing</h3>
                      <div class="card-tools">
                        <a class="btn btn-info btn-sm" href="event" title="Kembali"><i class="fas fa-angle-left"></i> Kembali</a>
                      </div>
                    </div>
                    <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text">Jumlah Module</span>
                                            <span class="info-box-number">1</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Detail Usability Testing</h3>
                    </div>
                            ...
                            <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-kandidat-tab" data-toggle="pill" href="https://tes-potensi.kemenkumham.go.id/events/statistic/488#pills-kandidat" role="tab" aria-controls="pills-kandidat" aria-selected="true">Kandidat</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-module-tab" data-toggle="pill" href="https://tes-potensi.kemenkumham.go.id/events/statistic/488#pills-module" role="tab" aria-controls="pills-module" aria-selected="false">Modul</a>
                                        </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#" aria-selected="true" style="background-color: green;">Tambah Peserta</a>
                                        </li>
                                        <li class="nav-item" style="opacity:0%">
                                            <a class="nav-link active" aria-selected="true"></a>
                                        </li>
                                        <li class="nav-item">
                                          
                                        <a class="nav-link active" href="#"  aria-selected="true" style="background-color: green;">Unggah Via Excel</a>
                                        </li>
                                        </ul>
                                    </div>
                                </div>
                                        <input type="hidden" id="kandidat-holder" class="kandidat_detail" name="kandidat_selected" value="">
                                        <input type="hidden" id="module-holder" class="module_detail" name="module_selected" value="[{&quot;mid&quot;:1898,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 1 General Sequential Reasoning&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1899,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 2 Inductive Non-Verbal Reasoning&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1900,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 3 Inductive Verbal&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1901,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 4 Quantitative Reasoning&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1902,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 5 Lexical Knowledge&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1903,&quot;nama&quot;:&quot;Modul Tes Kognitif - Sub Test 6 Perceptual Speed&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false},{&quot;mid&quot;:1904,&quot;nama&quot;:&quot;Modul Tes Kepribadian&quot;,&quot;event&quot;:488,&quot;is_new&quot;:false}]">          
                                        <div class="col-sm-12">
                                            <table id="myTable" class="table oli-table nowrap table-striped table-bordered table-hover" role="grid" style="width:100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">reska.nugroho@kemenkumham.go.id</th>
                                                        <th class="text-center">Analis Sistem Aplikasi dan Jaringan Komputer</th>
