  <div class="content-wrapper " style="min-height: 623.203px;">
              ...
              <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Data Pra Tes Potensi Ditjen PP 23 Nov 2024</h3>
                                ...
                                <div class="col-4">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">03 jam 01 menit</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Detail Pra Tes Potensi Ditjen PP 23 Nov 2024</h3>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link" id="pills-module-tab" data-toggle="pill" href="https://tes-potensi.kemenkumham.go.id/events/statistic/488#pills-module" role="tab" aria-controls="pills-module" aria-selected="false">Module</a>
                                      </li>
                                    </ul>
    ...
    <tbody>
        ...
        <th class="text-left">aaaaa</th>
            <th class="text-center">aaaa</th>
            <th class="text-center">bbbb</th>
            <th class="text-center">dddd</th>
            <th class="text-center">eeee</th>
        </tr>
         <tr>
        <th class="text-left">aaaaa</th>
            <th class="text-center">bbbb</th>
            <th class="text-center">cccc</th>
            <th class="text-center">dddd</th>
            <th class="text-center">eeee</th>
            </tr>
              <th class="text-left">aaaaa</th>
